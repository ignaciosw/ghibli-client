...
<ul class="tabs" data-tabs id="example-tabs">
	...
	<li class="tabs-title" id="tab-producers"><a href="#producers">PRODUCERS</a></li>
	<li class="tabs-title" id="tab-seen"><a href="#seen">SEEN BY ME</a></li>
	<li class="tabs-title" id="tab-random"><a href="#">RANDOM UNSEEN!</a></li>
</ul>